...
abstract class CustomTextStyles {
  ...
  static final TextStyle title1Sp = baseStyle.copyWith(fontSize: 38);
  static final TextStyle title1LightSp =
  ...
  static final TextStyle title2Sp = baseStyle.copyWith(fontSize: 32);
  ...
  static final TextStyle title3Sp = baseStyle.copyWith(fontSize: 22);
  ...
  static final TextStyle title4Sp = baseStyle.copyWith(fontSize: 20);
  ...
  static final TextStyle title5Sp = baseStyle.copyWith(fontSize: 18);
  ...
  static final TextStyle title6Sp = baseStyle.copyWith(fontSize: 16);
  ...
  static final TextStyle title7Sp = baseStyle.copyWith(fontSize: 14);
  ...
  static final TextStyle title8Sp = baseStyle.copyWith(fontSize: 30);
  ...
  static final TextStyle bodySp = baseStyle.copyWith(fontSize: 14);
  ...
  static final TextStyle smallBodySp = baseStyle.copyWith(fontSize: 13);
  ...
  static final TextStyle smallSp = baseStyle.copyWith(fontSize: 12);
  ...
  static final TextStyle extraSmallSp = baseStyle.copyWith(fontSize: 10);
